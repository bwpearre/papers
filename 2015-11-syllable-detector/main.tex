...
smoothing kernel around the target time with $\sigma\simeq 2$ ms serves
well.
...
The top panel of \fig{fig:song} shows the song for which we present results.  Three target syllables are shown, at 150, 315, and 405 milliseconds after the beginning of the aligned samples, as indicated by the red lines.  The rectangles show the recognition window (30 ms, 1-8 kHz) for each instant in the song.
