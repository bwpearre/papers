...
% ``detection point 4'', ``delta-function detection''
...
\begin{figure}
  ...
  \end{center}
  \caption{Timing data for our 6 test syllables, for the ideal and the Swift+serial detectors, with an FFT frame rate of 1.5 ms.  Point centres show latency; error bars show jitter.  Centres have been shifted slightly for clarity.}
