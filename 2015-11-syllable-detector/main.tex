...
Sample accuracy for a typical good syllable \marginpar{Should be! Verify! ALSO need to present a picture of the test syllable or etc\dots} are identical for the three detectors. An example confusion matrix looks like this:
