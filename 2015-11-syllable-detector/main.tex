...
In order to take advantage of this consistency,\marginpar{Examples of how this has been taken advantage of.} it is useful to be
able to detect selected moments during song, in order to align data or
trigger\marginpar{Examples?} other systems.  Important considerations for such a detector are as follows:
\begin{description}
...
\paragraph{Song micro-realignment}
...
\paragraph{Building the training set}
...
\paragraph{Computing optimal output thresholds}
...
\paragraph{Our parameter choices}
...
network's input space to be 20-100 ms long, and to span frequencies
