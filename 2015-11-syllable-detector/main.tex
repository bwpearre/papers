...
Ground truth is available for the whole dataset, and can be measured by
...
measure of performance.  We did not stray from the toolbox's default values, and do not discuss those training/validation/test sets here.
