...
frame interval of $t_f=1.5$ milliseconds.  We set the network's input
...
Detector latency and jitter depend on the FFT frame rate.  {\bf ??}\marginpar{fixme} shows how these numbers vary over a useful range of frame rates on our Swift detector with serial output, and for the LabView detector.  For our chosen default frame rate of 1.5 ms, we measured latency of \marginpar{FIXME}.
