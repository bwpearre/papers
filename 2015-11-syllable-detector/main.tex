...
fluctuate with audio output volume and the exact shape of the pulse will vary with the quality of the audio player) on the right channel. Thus, when
played on any audio player, the left channel may be provided as input
to the detector, and the right channel may be compared against
the detector's detection pulse.
