...
80\marginpar{How many runs in the end?} different
...
\end{description}
 ...
 \noindent Our implementation of the syllable
    detector is available under the GNU GPL:
    \begin{description}
    \item[Training the neural network:] {\tt https://github.com/bwpearre/birds/align}
