...
size of 64 samples (1.4ms at 44.1kHz), as this created minimal system
...
buffer (again, in 64 sample or 1.5ms chunks) to create a trigger 
...
on CPU usage (<10\%). Depending on the experimental needs, latency
