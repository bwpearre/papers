% Recognition region at one time but consisting of many times
% sigma vs other-sigma (shotgun)?
% Column of training matrix =/= column of spectrogram
% zscore question for Jeff
% What does each normalisation step do?
